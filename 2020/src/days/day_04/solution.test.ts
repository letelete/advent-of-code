...
pid:3556412378 byr:2007`;
  ...
  describe('Part two', () => {
    it('should return 0 with a sample input', () => {
...
describe('Final sample', () => {
  ...
  describe('Part one', () => {
    it('should return 206 with a sample input', () => {
      expect(partOne()).toEqual(206);
    });
  });

  describe('Part two', () => {
    it('should return 123 with a sample input', () => {
      expect(partTwo()).toEqual(123);
    });
  });
});
